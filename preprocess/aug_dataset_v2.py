...
vocabs_vn_accent = []
with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/all-vietnamese-syllables.txt", 'r') as rf:
...
with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/vn_remove_accent.txt", 'r') as rf:
    for line in rf.readlines():
        line = line.strip()
        line = norm_text(line)
        # line = remove_accent(line)
...
keys_break_typing = []
values_break_typing = []
with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/vn-break-typing.txt", 'r') as rf:
    for line in rf.readlines():
        line = line.strip()
        line = norm_text(line)
        line = line.split(' ')
...
keys_wrong_telex = []
values_wrong_telex = []
with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/all-vietnamese-words-wrong-telex.txt", 'r') as rf:
    for line in rf.readlines():
        line = line.strip()
        line = norm_text(line)
        line = line.split(' ')
...
with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/keys_random.json", 'r') as rf:
    data_keys_random = json.load(rf)
ls_key_random = list(data_keys_random.keys())


with open("/home/taibv/Documents/Projects/spellCorection/preprocess/vocab/keys_last.json", 'r') as rf:
