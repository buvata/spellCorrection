...
python3 preprocess.py --train_src data/train_data/sent_src.txt --train_tgt data/train_data/sent_des.txt --save_data data/new_data_train/new_spell -shard_size 2